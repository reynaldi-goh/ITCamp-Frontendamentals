# 📖 JavaScript Workshop – Hands-On Guide

Welcome to the crash course in JavaScript. This README is your code lab manual: you’ll find step-by-step instructions, copy-paste-ready code, and clear exercises. If you follow this file, you’ll be able to replicate everything we did in the workshop without panic googling.

## 1. Setup

Make a folder called `lesson4-ITCamp`.

Inside, create two files:
1. `index.html`
2. `script.js`

Here’s a starting template for `index.html`:
...
```
We can leave the `script.js` empty for now.
...
## 4. Document Object Model Manipulation
